...
public class Daycare_rule {
	...
	public static void demo() {
		...
		Student student1 = stf.createPerson("Kai,6,3,sdf,rge,123");
		Teacher teacher1 = tcf.createPerson("Robin,32,23");
		...
		System.out.println("teacher: " + dayCare.getTeacherName());
		System.out.println("group: " + dayCare.getGroupStuNum());
		System.out.println("class: " + dayCare.getClassNum());
